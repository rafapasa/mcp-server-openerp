...
--
-- Host: 172.20.131.38    Database: mcp_server_openerp
-- ------------------------------------------------------
...
CREATE TABLE `clientes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint unsigned NOT NULL,
  `telefone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Número do WhatsApp',
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome completo do cliente',
  `nome_perfil` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome do perfil do WhatsApp',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'E-mail do cliente',
  `inscricao_federal` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CPF (11 dígitos) ou CNPJ (14 dígitos)',
  `rg` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'RG (apenas pessoa física)',
  `inscricao_estadual` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Inscrição Estadual (pessoa jurídica)',
  `inscricao_municipal` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Inscrição Municipal (pessoa jurídica)',
  `status` enum('ativo','inativo','pendente_validacao') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ativo' COMMENT 'ativo, inativo, pendente_validacao',
  `status_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Motivo do status (ex: mudança de dono)',
  `status_updated_at` timestamp NULL DEFAULT NULL COMMENT 'Data da última mudança de status',
  `nome_anterior` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome anterior (para validação)',
  ...
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabela de clientes do sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clientes` VALUES (1,1,'65996908844','João Silva','João Silva','joao@email.com','00000000191',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:41:28','2026-08-11 23:41:28','2026-08-13 02:58:46'),(2,1,'5511988888888','Maria Santos','Maria S.','maria@email.com','00000000292',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:41:28','2026-08-11 23:41:28','2026-08-11 23:41:28'),(3,2,'5511977777777','Carlos Souza','Carlos Souza','carlos@email.com','00000000393',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:41:28','2026-08-11 23:41:28','2026-08-11 23:41:28'),(4,1,'5511999999999','João Silva','João Silva','joao@email.com','00000000191',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14','2026-08-11 23:59:14'),(5,1,'5511988888888','Maria Santos','Maria S.','maria@email.com','00000000292',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14','2026-08-11 23:59:14'),(6,2,'5511977777777','Carlos Souza','Carlos Souza','carlos@email.com','00000000393',NULL,NULL,NULL,'ativo',NULL,NULL,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14','2026-08-11 23:59:14');
...
CREATE TABLE `enderecos` (
  ...
  `cep` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CEP (formato: 00000-000)',
  `logradouro` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nome da rua/avenida',
  `numero` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Número do imóvel',
  `complemento` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Complemento (apto, bloco, etc)',
  `bairro` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bairro',
  `cidade` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Cidade',
  `estado` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'UF (SP, RJ, etc)',
  `pais` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Brasil' COMMENT 'País',
  `referencia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ponto de referência',
  ...
  `geolocalizacao_fonte` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Fonte: whatsapp, viacep, google, manual',
  `tipo` enum('residencial','comercial','entrega','cobranca') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'entrega',
  `principal` tinyint(1) DEFAULT '0' COMMENT 'Endereço principal para entregas',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT 'Data de exclusão lógica (endereço inativo)',
  `observacoes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Observações sobre o endereço',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Endereços dos clientes (com soft delete)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `enderecos` VALUES (1,1,'01234-567','Rua das Flores','123','Apto 42','Jardim Paulista','São Paulo','SP','Brasil',NULL,-23.55052000,-46.63330800,'manual','residencial',1,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14'),(2,1,'01234-568','Av. Paulista','1000','Conjunto 51','Cerqueira César','São Paulo','SP','Brasil',NULL,-23.56180000,-46.65580000,'manual','comercial',0,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14'),(3,2,'04567-890','Rua dos Pinheiros','456',NULL,'Pinheiros','São Paulo','SP','Brasil',NULL,-23.56240000,-46.69710000,'manual','residencial',1,NULL,NULL,'2026-08-11 23:59:14','2026-08-11 23:59:14');
...
INSERT INTO `goose_db_version` VALUES (1,0,1,'2026-09-05 06:20:01'),(2,1,1,'2026-09-05 06:20:01'),(3,2,1,'2026-09-05 06:20:01'),(4,3,1,'2026-09-05 06:20:01'),(5,4,1,'2026-09-05 06:24:26'),(6,5,1,'2026-09-05 06:24:46'),(7,6,1,'2026-09-05 06:24:47');
/*!40000 ALTER TABLE `goose_db_version` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pedido_pagamentos`
--
...
--
-- Dumping data for table `pedido_pagamentos`
--

LOCK TABLES `pedido_pagamentos` WRITE;
/*!40000 ALTER TABLE `pedido_pagamentos` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_pagamentos` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `pedidos_ibfk_3` FOREIGN KEY (`endereco_entrega_id`) REFERENCES `enderecos` (`id`) ON DELETE SET NULL
...
INSERT INTO `pedidos` VALUES (1,1,NULL,NULL,'Rafael pasa','65996908844 ','[{\"nome\": \"X-Bacon\", \"observacao\": \"\", \"quantidade\": 1, \"preco_unitario\": 29.9}, {\"nome\": \"Água Mineral\", \"observacao\": \"bem gelada\", \"quantidade\": 1, \"preco_unitario\": 3.5}, {\"nome\": \"Coca-Cola Lata\", \"observacao\": \"bem gelada\", \"quantidade\": 1, \"preco_unitario\": 6}]',39.40,'confirmado','Bebidas bem geladas',30,'whatsapp','2026-08-10 18:29:20.464','2026-08-10 18:29:20.464'),(2,3,NULL,NULL,'Rafael Pasa','65996908844','[{\"nome\": \"Máscara de Cílios\", \"observacao\": \"\", \"quantidade\": 1, \"preco_unitario\": 35.9}, {\"nome\": \"Losartana 50mg\", \"observacao\": \"\", \"quantidade\": 1, \"preco_unitario\": 32.9}]',68.80,'confirmado','Cliente solicitou informação de preço',25,'whatsapp','2026-08-10 18:34:41.142','2026-08-10 18:34:41.142'),(3,3,NULL,NULL,'Rafael Pasa','65996908844','[{\"nome\": \"Paracetamol 750mg\", \"observacao\": \"Solicitado Tylenol; prefere genérico se disponível\", \"quantidade\": 1, \"preco_unitario\": 12.9}, {\"nome\": \"Dipirona 500mg\", \"observacao\": \"Solicitado 1mg; prefere genérico se disponível\", \"quantidade\": 1, \"preco_unitario\": 8.9}]',21.80,'confirmado','Cliente aceita medicamentos genéricos se houver opção',25,'whatsapp','2026-08-10 18:40:51.612','2026-08-10 18:40:51.612'),(4,1,NULL,NULL,'Olise','65996908844','[{\"nome\": \"X-Bacon\", \"observacao\": \"\", \"quantidade\": 1, \"preco_unitario\": 29.9}, {\"nome\": \"Coca-Cola Lata\", \"observacao\": \"zero\", \"quantidade\": 1, \"preco_unitario\": 6}]',35.90,'confirmado','',25,'whatsapp','2026-08-10 18:44:26.611','2026-08-10 18:44:26.611');
...
CREATE TABLE `produtos` (
  ...
  KEY `idx_produtos_tenant_nome` (`tenant_id`,`nome`),
...
CREATE TABLE `tenants` (
  ...
  `whatsapp_display_number` varchar(20) DEFAULT NULL,
  `whatsapp_verify_token` varchar(500) DEFAULT NULL,
  `segmento` varchar(50) DEFAULT 'geral',
  `ativo` tinyint(1) DEFAULT '1',
  `created_at` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenants_whatsapp_phone_id` (`whatsapp_phone_id`),
  KEY `idx_tenants_waba_id` (`waba_id`)
...
INSERT INTO `tenants` VALUES (1,'FastFood do Zé','12.345.678/0001-90','(11) 99999-9999','Rua das Flores, 123 - São Paulo/SP','1085153967394498','1337919362728144',NULL,'7f3a8e2b-1c4d-4f6a-8b2e-9d1c3a5f7e8d','geral',1,'2026-08-10 17:21:18.000'),(2,'Mercado Popular','23.456.789/0001-01','(11) 88888-8888','Av. Principal, 456 - São Paulo/SP',NULL,'000000000000000','00000000000',NULL,'geral',1,'2026-08-10 17:21:32.000'),(3,'Farmácia Saúde','34.567.890/0001-12','(11) 77777-7777','Rua da Saúde, 789 - São Paulo/SP',NULL,'111111111111111','11111111111',NULL,'geral',1,'2026-08-10 17:21:42.000');
...
INSERT INTO `users` VALUES (1,1,'Admin','etoolstec@etoolstec.com.br','$2a$10$BzyDBRWWadG2NrOgpP.7Me8fg0o1sJLCF8cW4yqM2IQ6LFAFY9Gvi','admin',1,'2026-09-02 17:11:56','2026-09-05 19:47:24');
...
-- Dump completed on 2026-09-05 23:10:53
